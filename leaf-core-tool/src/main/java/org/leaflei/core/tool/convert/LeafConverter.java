...
import org.leaflei.core.tool.support.Try;
import org.leaflei.core.tool.utils.ClassUtil;
import org.leaflei.core.tool.utils.ConvertUtil;
import org.leaflei.core.tool.utils.ReflectUtil;
...
@Slf4j
@AllArgsConstructor
public class LeafConverter implements Converter {
	...
	public Object convert(Object value, Class target, final Object fieldName) {
		...
		try {
			TypeDescriptor targetDescriptor = LeafConverter.getTypeDescriptor(targetClazz, (String) fieldName);
			return ConvertUtil.convert(value, targetDescriptor);
		} catch (Throwable e) {
			log.warn("LeafConverter error", e);
			return null;
		}
	}
