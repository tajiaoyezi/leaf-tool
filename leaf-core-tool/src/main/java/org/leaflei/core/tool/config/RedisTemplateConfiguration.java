...
import org.leaflei.core.tool.redis.RedisKeySerializer;
import org.leaflei.core.tool.utils.RedisUtil;
...
@AutoConfiguration
@AutoConfigureBefore(RedisAutoConfiguration.class) // 自动配置顺序
